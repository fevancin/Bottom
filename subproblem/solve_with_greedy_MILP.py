...
def solve_day(day_name):
    ...
    def f7(model, patient_name, service_name1, service_name2):
        ...
        return (model.t[patient_name, service_name1] + service_duration * model.x[patient_name, service_name1] <=
            model.t[patient_name, service_name2] +
    ...
    def f8(model, patient_name, service_name1, service_name2):
        ...
        return (model.t[patient_name, service_name2] + service_duration * model.x[patient_name, service_name2] <=
            model.t[patient_name, service_name1] +
    ...
    def f9(model, operator_name, patient_name1, service_name1, patient_name2, service_name2):
        service_duration = services[service_name1]['duration']
        return (model.t[patient_name1, service_name1] + service_duration * model.chi[patient_name1, service_name1, operator_name] <=
    ...
    def f10(model, operator_name, patient_name1, service_name1, patient_name2, service_name2):
        service_duration = services[service_name2]['duration']
        return (model.t[patient_name2, service_name2] + service_duration * model.chi[patient_name2, service_name2, operator_name] <=
